  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        const hasAutoBookingChannel = channels.some((c) => c.accepts_auto_booking);
        ...
        let awolCheckFailed = false;
        if (hasAutoBookingChannel) {
          try {
